...
# URL do Campeonato Brasileiro Série A no Transfermarkt
url = 'https://www.transfermarkt.com.br/esporte-clube-bahia/startseite/verein/10010/saison_id/2022'
...
if response.status_code == 200:
    ...
    if players_table:
        ...
        with open('info_atletas4.txt', 'w', encoding='utf-8') as file:
        ...
        print("Informações dos atletas foram coletadas e salvas no arquivo 'info_atletas.txt'.")
    else:
